...
#include "ObsEvent/Public/K2Node_ConstructObsPayload.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	OBSEVENT_API UClass* Z_Construct_UClass_UK2Node_ConstructObsPayload_NoRegister();
	OBSEVENT_API UClass* Z_Construct_UClass_UK2Node_ConstructObsPayload();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UK2Node_ConstructObsPayload_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "K2Node_ConstructObsPayload.h" },
		{ "ModuleRelativePath", "Public/K2Node_ConstructObsPayload.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(UK2Node_ConstructObsPayload, 1474205626);
	template<> OBSEVENT_API UClass* StaticClass<UK2Node_ConstructObsPayload>()
	{
		return UK2Node_ConstructObsPayload::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UK2Node_ConstructObsPayload(Z_Construct_UClass_UK2Node_ConstructObsPayload, &UK2Node_ConstructObsPayload::StaticClass, TEXT("/Script/ObsEvent"), TEXT("UK2Node_ConstructObsPayload"), false, nullptr, nullptr, nullptr);
